...
**Key Features:**
- 📊 **7 Approximation Levels**: From char-0 (random) to word-3 (trigram-based)
- 🔍 **Text Analysis Pipeline**: Extract character and word n-gram frequencies
- 📝 **Text Generation Engine**: Generate text using Markov chains
- 🎯 **Anchor Words**: Integrate specific words naturally into generated text
- 🎭 **Multi-Author Support**: Generate text mimicking Austen, Twain, or Doyle
- 🔀 **Style Blending**: (Bonus) Mix styles from multiple authors
...
├── README.md                          # This file
├── starter_preprocess.py              # Text preprocessing utilities (provided)
├── analyze.py                         # Part 2: Statistical analysis
├── generator.py                       # Part 3: Text generation engine
├── shannon_gen.py                     # Part 4: CLI interface
├── test_generator.py                  # Testing suite
│
├── Text Files:
├── austen_pride_prejudice.txt         # Source text: Pride and Prejudice
├── twain_tom_sawyer.txt               # Source text: Tom Sawyer
├── doyle_sherlock_holmes.txt          # Source text: Sherlock Holmes
│
├── frequency_data (generated by analyze.py):
├── austen_*.json                      # Austen frequency tables
├── twain_*.json                       # Twain frequency tables
├── doyle_*.json                       # Doyle frequency tables
│
├── samples:
├── austen_*.txt                      
├── twain_*.txt                       
├── doyle_*.txt         
              # Doyle frequency tables
└── Analysis:
    └── Report.pdf       # Assignment 5: Analysis and Reflection
```
...
4. **Verify the setup:**
   ...
   python3 -c "from starter_preprocess import TextPreprocessor; print('✅ Setup successful!')"
   ```
...
4. ✅ Character-level generation (all 4 levels)
5. ✅ Word-level generation (all 3 levels)
6. ✅ Anchor word integration
7. ✅ All three authors
...
### Complete Analysis → Generation → Comparison Workflow
...
✅ analyze.py                          (Part 2)
✅ generator.py                        (Part 3)
✅ shannon_gen.py                      (Part 4)
✅ test_generator.py                   (Testing)
✅ starter_preprocess.py               (Provided)
✅ Part5_Analysis_Report.md            (Part 5)
✅ README.md                           (This file)
✅ All JSON frequency files            (21 files: 7 per author)
✅ All text files                      (3 files: Austen, Twain, Doyle)
...
The progression from char-0 (random gibberish) through word-3 (nearly coherent sentences) shows that language is highly predictable from local context—a key insight that motivates all modern NLP approaches.
